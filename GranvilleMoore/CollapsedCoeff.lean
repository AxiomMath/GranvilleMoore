...
public import GranvilleMoore.BinomPoly
public import GranvilleMoore.CoefficientAnalysis
...
@[granville_moore "lem_A_vanishes"]
...
@[granville_moore "lem_A_valuation"]
...
private theorem padicValRat_natCast_sub_one {p : ℕ} (hp : p.Prime) :
