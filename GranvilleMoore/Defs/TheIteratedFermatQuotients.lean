...
@[granville_moore "def_iterated_quotient"]
...
@[granville_moore "def_c_coefficients"]
...
@[granville_moore "def_unit_quotient"]
...
@[granville_moore "def_binom_poly"]
