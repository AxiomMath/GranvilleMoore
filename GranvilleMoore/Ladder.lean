...
public import GranvilleMoore.Defs.TheMooreDeterminant
...
@[granville_moore "lem_row_difference"]
...
@[granville_moore "lem_ladder_start"]
...
`F⁽ʳ⁾_0`. -/
@[granville_moore "lem_ladder_last_entries"]
...
@[granville_moore "lem_ladder_step"]
...
@[granville_moore "lem_ladder_exponent"]
...
@[granville_moore "lem_det_factor"]
